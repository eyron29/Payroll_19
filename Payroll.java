...
//        }//isValidInput3
    ...
    public static void hoursWorkded(){
        ...
        while(!isValidInput3){
            try {
                System.out.print("Weeks that employee is present : ");
                String input = inp.nextLine(); // String input
        ...
        for(weeks = 0; weeks < weeksPresent; weeks++){
            System.out.println("Employee hours work week " + (weeks + 1) + " : ");

            for(days = 0; days <5; days++){
                while(!isValidInput3){
                    try {
                        System.out.print("Hours Worked day " + (days + 1) + " : ");
                        String input = inp.nextLine(); // String input
